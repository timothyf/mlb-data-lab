...
class StatsConfig:
    ...
    stat_lists = {
        'batting': {
            'standard': ['gamesPlayed', 'plateAppearances', 'atBats', 'hits', 'doubles', 'triples', 'homeRuns', 'runs', 'rbi', 'baseOnBalls', 'intentionalWalks', 'strikeOuts', 'hitByPitch', 'sacFlies', 'sacBunts', 'groundIntoDoublePlay', 'stolenBases', 'caughtStealing', 'avg'],
        ...
        'pitching': {
            'standard': ['wins', 'losses', 'era', 'gamesPitched', 'gamesStarted', 'qualityStarts', 'completeGames', 'shutouts', 'saves', 'holds', 'blownSaves', 'inningsPitched', 'battersFaced', 'hits', 'runs', 'earnedRuns', 'homeRuns', 'baseOnBalls', 'intentionalWalks', 'hitBatsmen', 'wildPitches', 'balks', 'strikeOuts'],
...
class StatsDisplayConfig:
    ...
    pitching = {
        'wins': {'table_header': r'$\bf{W}$', 'format': ''},
        'losses': {'table_header': r'$\bf{L}$', 'format': ''},
        'saves': {'table_header': r'$\bf{SV}$', 'format': ''},
        'inningsPitched': {'table_header': r'$\bf{IP}$', 'format': ''},
        'strikeOuts': {'table_header': r'$\bf{SO}$', 'format': ''},
        'battersFaced': {'table_header': r'$\bf{TBF}$', 'format': ''},
        ...
        'earnedRuns': {'table_header': r'$\bf{ER}$', 'format': ''},
        ...
        'gamesPitched': {'table_header': r'$\bf{G}$', 'format': ''},
        'gamesStarted': {'table_header': r'$\bf{GS}$', 'format': ''},
        'completeGames': {'table_header': r'$\bf{CG}$', 'format': ''},
        'shutouts': {'table_header': r'$\bf{SHO}$', 'format': ''},
        'qualityStarts': {'table_header': r'$\bf{QS}$', 'format': ''},
        'wildPitches': {'table_header': r'$\bf{WP}$', 'format': ''},
        'balks': {'table_header': r'$\bf{BK}$', 'format': ''},
        'RS/9': {'table_header': r'$\bf{RS\ /\;9}$', 'format': '.2f'},
        'H/9': {'table_header': r'$\bf{H\ /\;9}$', 'format': '.2f'},
        'Swing%': {'table_header': r'$\bf{Swing\%}$', 'format': 'percent'},
        'holds': {'table_header': r'$\bf{HLD}$', 'format': ''},
        'blownSaves': {'table_header': r'$\bf{BS}$', 'format': ''},
